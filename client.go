...
// APIClient manages communication with the Observability Service API API v1.0
...
type APIClient struct {
	...
	MicrobatchesAPI *MicrobatchesAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.MicrobatchesAPI = (*MicrobatchesAPIService)(&c.common)
